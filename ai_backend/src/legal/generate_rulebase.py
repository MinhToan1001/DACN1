...
laws_config["THONG_THUONG"] = {
    "group_name": "Động vật rừng thông thường",
    "ordinary_captivity_conditions": [
        ...
        "Thực hiện ghi chép sổ theo dõi vật nuôi theo Mẫu số 16 tại Phụ lục ban hành kèm Nghị định 06/2019/NĐ-CP.",
        "Trong thời hạn tối đa 03 ngày làm việc kể từ ngày đưa động vật rừng thông thường về cơ sở nuôi, tổ chức/cá nhân phải gửi thông báo cho cơ quan Kiểm lâm sở tại để theo dõi, quản lý.",
    ],
    "legal_note": (
        "Không sinh các khung phạt theo giá trị tang vật cho tình huống nuôi động vật rừng thông thường; "
        "chỉ hiển thị điều kiện nuôi theo Điều 11 Nghị định 06/2019/NĐ-CP."
    ),
}
