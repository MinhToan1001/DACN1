...
class RareAnimalDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> Tuple:
        ...
        try:
            ...
            logger.warning(f"Lỗi đọc ảnh {img_path}: {e}. Dùng ảnh xám.")
...
class FocalLoss(nn.Module):
    """
    Focal Loss với hỗ trợ class-weight Tensor.
...
# ============================================================
# BƯỚC 8: FEW-SHOT LEARNING (Prototypical Network)
# ============================================================
...
def main():
    ...
    result = pipeline.run()
    logger.info(f"\nSẵn sàng training với {result['num_classes']} classes!")
